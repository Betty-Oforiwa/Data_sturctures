...
//        number of positive numbers,number of negative numbers,number of odd numbers
//        number of even numbers and number of 0s.
...
//        Write a program to find the sum and product of all elements of an array.
        ...
        for (int i = 0; i < array.length; ++i) {
            ...
            int[][] twoD = {{1, 2, 3}, {4, 6, 7, 8}};
            System.out.println();
            for (int d = 0; d < twoD.length; d++)
                for (int c = 0; c < twoD[d].length; c++) {
                    System.out.println(twoD[d][c]);
                }
        }
